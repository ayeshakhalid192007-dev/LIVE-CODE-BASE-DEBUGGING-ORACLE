...
- VS Code installed
- Claude for VS Code extension installed (from marketplace)
- Qdrant running

### Setup

1. **Install extension**: Search "Claude" in VS Code extensions, install by Anthropic.

2. **Configure MCP server**: Same as Claude Desktop setup above—edit the Claude config file.

3. **Restart VS Code**.

4. **Open Claude sidebar**: Click Claude icon in activity bar.

### Usage

1. Open your repository in VS Code.
2. In Claude sidebar, tools appear under "Available Tools".
3. Call `index_repo` to index your repository.
4. When error occurs, paste stacktrace and call `debug_error`.
...
- JetBrains IDE with recent version
- Claude plugin from JetBrains marketplace
- Qdrant running
...
1. **Install plugin**:
   ...
   - Search "Claude", install by Anthropic

2. **Configure MCP server**: Same as Claude Desktop setup—edit the Claude config file.

3. **Restart IDE**.

4. **Open Claude panel**: View → Tool Windows → Claude.

### Usage

1. Open your repository in IDE.
2. In Claude panel, tools appear in MCP tools section.
3. Call `index_repo` to index repository.
4. When error occurs, paste stacktrace and call `debug_error`.
